...
(function(e, t, n) {
  var r = {
    ...
    logIn: function() {
      var e = this;
      e.$elem.data({"owl-originalStyles": e.$elem.attr("style"), "owl-originalClasses": e.$elem.attr("class")});
    ...
    appendWrapperSizes: function() {
      ...
      e.$owlWrapper.css({width: *2, left: 0});
      e.appendItemsSizes()
    },
    ...
    updatePagination: function() {
      ...
      for (s = 0; s < t.itemsAmount; s += 1) {
        if (s % t.options.items === 0) {
          ...
          u = e("<span></span>", {
            text: t.options.paginationNumbers === true
              ? n
              : "",
            "class": t.options.paginationNumbers === true
              ? "owl-numbers"
              : ""
          });
          o.append(u);
    ...
    next: function(e) {
      ...
      t.currentItem += t.options.scrollPerPage === true
        ? t.options.items
        : 1;
      if (t.currentItem > t.maximumItem + (t.options.scrollPerPage === true
        ? t.options.items - 1
        : 0)) {
    ...
    closestItem: function() {
      var t = this,
        n = t.options.scrollPerPage === true
          ? t.pagesInArray
          : t.positionsInArray,
        r = t.newPosX,
        i = null;

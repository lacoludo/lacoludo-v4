...
window.scrollReveal = (function(window) {
  ...
  scrollReveal.prototype = {
    ...
    getOffset: function(el) {
      ...
      } while (el = el.offsetParent)return {top: offsetTop, left: offsetLeft}
    },
    ...
    isElementInViewport: function(el, h) {
      ...
      return (elTop + elH * h) <= viewed && (elBottom) >= scrolled || (el.currentStyle
        ? el.currentStyle
        : window.getComputedStyle(el, null)).position == 'fixed';
    },
